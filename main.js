...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/v2jQiKwGY/model.json', modelloaded)
function modelloaded() { console.log("modelloaded");
}
function speak() {
    var synth = window.speechSynthesis;
    speak_dataone = "the first prediction is" + prediction_one;
    speak_datatwo = "and the second prediction is" + prediction_two
;
var utterThis = new SpeechSynthesisUtterance(speak_dataone + speak_datatwo);
